class Game {
  ...
  start() {
    ...
    this.addSprites(fuels, 4, fuelImage, 0.02,0);

    this.addSprites(obstacles,6,obstacle1Img,0.04, obstaclesPositions);

    // Adding coin sprite in the game
    this.addSprites(powerCoins, 18, powerCoinImage, 0.09,0);
  }
